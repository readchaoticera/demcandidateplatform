...
Generated 2026-08-28 16:27 UTC, reflecting the field as of August 28, 2026.
...
| Position read from their own campaign site | 254 |
| Position from news coverage (site unreadable) | 68 |
| No position from any source | 4 |

Combined, **428 of 432** candidates (99%) now have a position from some source, leaving **4** with none.
...
- 6 of 432 on-ballot candidates have no matching FEC filing; their names may be transcribed incorrectly
